...
const Register = () => {
  ...
  const handleSubmit = (event: FormEvent) => {
    ...
    if (!image) setImage('https://t3.ftcdn.net/jpg/03/46/83/96/360_F_346839683_6nAPzbhpSkIpb8pmAwufkC7c5eD7wYws.jpg');
    ...
    <div className="bg-gray-900 form__container w-screen h-screen flex justify-center items-center sm:p-4">
      ...
      >
        ...
        <div className="flex flex-col mt-4">
          ...
          >
            Confirm Password{" "}
            {passwordConfirmationError && <span className="text-red-300">-</span>}
            <span className="capitalize font-normal italic text-red-300">
